...
//(*InternalHeaders(GenaUniversalFrame)
#include <wx/intl.h>
#include <wx/string.h>
//*)
...
GenaUniversalFrame::GenaUniversalFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Connect(idMenuQuit,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&GenaUniversalFrame::OnQuit);
    Connect(idMenuAbout,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&GenaUniversalFrame::OnAbout);
    //*)
}

GenaUniversalFrame::~GenaUniversalFrame()
{
    //(*Destroy(GenaUniversalFrame)
    //*)
}

void GenaUniversalFrame::OnQuit(wxCommandEvent& event)
{
    Close();
}

void GenaUniversalFrame::OnAbout(wxCommandEvent& event)
{
